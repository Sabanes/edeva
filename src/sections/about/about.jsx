    ...
    <div className="about smooth-scroll !z-10 max-w-[1500px]" data-scroll-container id="scroll-container">
          ...
          <div className="mt-10 flex flex-col">
            ...
            <span>
              <a
                ...
                href="https://maps.app.goo.gl/SMmE2kugjkNEE5Gr9"
              >
                Oeiras, 2780-236
              </a>
            </span>
            ...
            <br />
            <span>
              <a className="cursor-pointer underline" href="mailto:evavieiradealmeida@hotmail.com">
                evavieiradealmeida@hotmail.com
              </a>
            </span>
          </div>
        </div>
      ...
      <section className="hero-img pt-10 pb-20" data-scroll-section>
        <div className="hero-img-container m-auto pt-10">
          <img
            loading="lazy"
            className="rounded-2xl h-[30rem] object-cover w-[95%] m-auto"
            src="https://images.pexels.com/photos/119810/pexels-photo-119810.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            alt=""
          />
        </div>
      </section>
      ...
      <section id="about-sticky-wrap" data-scroll-section>
        ...
        >
          <div className="sticky-content">
            <h1 className="num">Openclasses</h1>
            <div className="relative mt-5 md:max-w-[90%] max-w-full">
              <TextGenerateEffect
                className="pl-2 font-light pb-10 text-[var(--main)]"
              ...
              />
              <button className="ml-2 group relative px-4 py-2 overflow-hidden rounded-full bg-[var(--main)] md:text-md text-sm shadow border">
        ...
        <div
          className="about-sticky about-sticky-2"
          data-scroll
          data-scroll-sticky
          data-scroll-target="#about-sticky-wrap"
        >
          <div className="sticky-content">
            <h1 className="num">Vocs</h1>
            <div className="relative mt-5 md:max-w-[90%] max-w-full">
              <TextGenerateEffect
                className="pl-2 font-light pb-10"
                words="Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima animi error est neque magnam. Doloribus aut omnis laborum hic rerum dignissimos blanditiis expedita facilis consequuntur, voluptate voluptates quasi consequatur accusantium? Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima animi error est neque magnam. Doloribus aut omnis laborum hic rerum dignissimos blanditiis expedita facilis consequuntur, voluptate voluptates quasi consequatur accusantium?"
              />
              <button className="ml-2 group relative px-4 py-2 overflow-hidden rounded-full bg-white md:text-md text-sm shadow border">
