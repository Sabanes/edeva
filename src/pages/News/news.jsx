...
const News = () => {
  return (
    ...
    <div className='bg-[var(--main)] mt-10'>
        <h1 className=' text-white md:text-9xl text-8xl'>MAY -&nbsp;MAY -&nbsp;</h1>
    </div>
    ...
    <div className='bg-[var(--main)] mt-10'>
        <h1 className=' text-white md:text-9xl text-8xl'>JUNE -&nbsp;JUNE -&nbsp;</h1>
    </div>
    ...
    <div className='bg-[var(--main)] mt-10'>
        <h1 className=' text-white md:text-9xl text-8xl'>JULY -&nbsp;JULY -&nbsp;</h1>
    </div>
