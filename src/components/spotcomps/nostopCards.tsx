...
export function InfiniteMovingCardsDemo() {
  return (
    <>
    <section className="h-[30rem] w-full rounded-md flex flex-col antialiased  items-center justify-center relative overflow-hidden">
      <h1 className=" text-3xl font-regular py-10  md:text-[3rem] text-[2.5rem] uppercase">Whats People think about us</h1>
      <InfiniteMovingCards
        items={testimonials}
        direction="right"
        speed="normal"
      />
            ...
            <div className="w-full flex flex-col items-center justify-center">
               <a target="_blank" href="https://terzihan.com/"><p className=" underline relative top-10">Axis Dental Clinic &#8599;</p></a>  
